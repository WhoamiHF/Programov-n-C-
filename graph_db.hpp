...
private:
   ...
   // std::unordered_map<vUser_t, size_t> IDs;
};
...
public:
    ...
    index(index_),edges(edges_),vertices(vertices_){}
    /**
     * @brief Returns the immutable user id of the element.
     */
    auto id() const {
...
private:
    edges_t<eProperty_t,eUser_t>& edges;
    size_t index;
    vertices_t<vProperty_t, vUser_t>& vertices;
};
...
public:
     ...
     * @see vertex
     */
    using vertex_t = vertex_t<typename GraphSchema::vertex_property_t, typename GraphSchema::vertex_user_id_t, typename GraphSchema::edge_property_t, typename GraphSchema::edge_user_id_t>;
        /**
         * @brief A type representing an edge.
         * @see edge
         */
    using edge_t = edge_t<typename GraphSchema::edge_property_t, typename GraphSchema::edge_user_id_t>;
...
private:
    edges_t<typename GraphSchema::edge_properties_t, typename GraphSchema::edge_user_id_t> edges;
    vertices_t<typename GraphSchema::vertex_property_t, typename GraphSchema::vertex_user_id_t, typename GraphSchema::edge_property_t, typename GraphSchema::edge_user_id_t> vertices;
};
